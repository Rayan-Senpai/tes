...
\033[1;92m--------------------------------------------------➤
  ''')
    print('' + Back.BLUE + Fore.BLACK + '        Creator : Rayan-XD         \033[00m')
    print()
...
def masuk():
    try:
          ...
          cek = input("cookies lern 👉      http://wa.me/+6285852768706?text=assalammualaikum+admin+ganteng+order+lisensi+dong6gg👈👈  Akan di arahkan ke wa admin👈👈👉👉enter \033[00m Masukan Cookies : \033[1;96m")
    cek = {"cookie":cek}
